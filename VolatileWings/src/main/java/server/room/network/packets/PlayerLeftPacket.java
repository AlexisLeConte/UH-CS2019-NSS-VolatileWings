...
public class PlayerLeftPacket extends NetworkPacket {
    private final String username;
    private final byte team;
    
    public PlayerLeftPacket(Player player) {
        username = player.getUsername();
        team = player.getTeam();
    }
    
    public PlayerLeftPacket(byte[] bytes) {
    ...
    public byte[] getBytes() {
        ...
        buffer.put(NetworkPacket.LEFT_PACKET);
